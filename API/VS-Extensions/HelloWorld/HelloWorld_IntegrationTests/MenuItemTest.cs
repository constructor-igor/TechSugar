...
namespace HelloWorld_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(constructorigor.HelloWorld.GuidList.guidHelloWorldCmdSet, (int)constructorigor.HelloWorld.PkgCmdIDList.cmdidHelloWorldCommand);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "HelloWorld", "constructorigor.HelloWorld.HelloWorldPackage");

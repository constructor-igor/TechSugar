...
using constructorigor.HelloWorld;

namespace HelloWorld_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new HelloWorldPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(constructorigor.HelloWorld.GuidList.guidHelloWorldCmdSet, (int)constructorigor.HelloWorld.PkgCmdIDList.cmdidHelloWorldCommand);

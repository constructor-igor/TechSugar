...
namespace DynamicProxy
{
    ...
    {
        /// <summary>
        /// Main functionOrProperty for adding transformers.
        /// </summary>
        /// <typeparam name="T1">Input Type</typeparam>
        /// <typeparam name="TResult">Result Type</typeparam>
        /// <param name="functionOrProperty">An expression pointing to the fucntion or a function or parameter</param>
        ...
        IProxy<T> AddTransformer<T1, TResult>(Expression functionOrProperty, Direction direction, Func<T1, TResult> transformer);

        /// <summary>
        /// Convenience function for adding a transformer with the same input as output to a function.
        /// </summary>

...
D:\My\@gh\TechSugar\DDS\HelloWorld\sacs_helloworld_sub\bin\Debug\sacs_helloworld_sub.exe
rem D:\My\@gh\TechSugar\DDS\HelloWorld\sacs_helloworld_pub\bin\Debug\sacs_helloworld_pub.exe

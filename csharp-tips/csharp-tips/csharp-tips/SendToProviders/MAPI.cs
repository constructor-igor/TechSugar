...
{
    //
    // from answer http://stackoverflow.com/questions/20328598/open-default-mail-client-along-with-a-attachment
    //
    class MAPI
    {
        ...
        public int ComposeMail(string[] recipients, string subject, string body, string[] attachments)
        {
            try
            {
                ...
                return this.SendMailPopup(subject, body);
            }
            catch (Exception)
            {
                throw;
